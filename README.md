...
| `/multiauth info [player]` | — | View account info (no arg = self; others require admin; shows type/UUID/first join/last IP/geo/online status, plus logout location and associated accounts for admins) |
